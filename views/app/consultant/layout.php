<div id="sidemenu" class="menu-collapsed">
	...
	<div id="profile">
		...
		<div id="name"><span><?php echo $_SESSION["consultant"]["nombre"]; ?></span></div>
	</div>
	<!--ITEMS-->
	<div id="menu-items">
		<div class="item">
			<a href="index.php?c=consultant&a=index">
				<div class="icon">
		...
		<div class="item">
			<a href="index.php?c=consultant&a=dates">
				<div class="icon">
		...
		<div class="item">
			<a href="index.php?c=consultant&a=profile">
				<div class="icon">
